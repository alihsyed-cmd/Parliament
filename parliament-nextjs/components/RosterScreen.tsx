...
// components/RosterScreen.tsx — full jurisdiction roster (leadership block + searchable list).
...
export function RosterScreen({
  ...
  const src = data ?? level; // fall back to embedded lookup data until fetch returns
