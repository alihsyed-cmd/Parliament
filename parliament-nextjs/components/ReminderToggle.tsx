...
// components/ReminderToggle.tsx — election-reminder opt-in.
// V1: persists consent + postal code to localStorage (see lib/reminders.ts).
// The actual push delivery is wired during the native build.
